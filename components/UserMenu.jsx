                ...
                {isOpen ? (
                    <ul className="absolute bg-white flex flex-col">
                        <div className="relative">
                            <Link href={'/profile'}>
                                <li className={`hover:bg-[#909090] hover:text-[white] pl-[0.4rem] pr-[2rem] py-[0.6rem] cursor-pointer`}>
                                    Profile account
                                </li>
                            </Link>
                        </div>
                        ...
                        <li onClick={handleClick} className="hover:bg-[#909090] hover:text-[white] pl-[0.4rem] pr-[2rem] py-[0.6rem] cursor-pointer">
                            Log out
                        </li>
                    </ul>
                ) : (
