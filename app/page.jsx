			...
			<section className='flex w-[80%] mx-[auto]  justify-center py-[3rem]'>
				<div className='w-[60%] pt-[2rem] text-center'>
					...
					<p className='w-[60%] mx-[auto] mt-[2rem] text-[1.4rem]'>
						...
						magnam vitae nisi consequuntur dicta culpa architecto iure possimus?
					</p>
				</div>
				<Image
					...
					<div className='flex mb-[2rem] gap-x-[3rem] items-center'>
						...
						<div className='w-[40%]'>
							...
							<p>
								...
								eos facere vero, laborum fugiat ipsum quis autem iusto, aut,
								ipsam magnam vitae nisi consequuntur dicta culpa architecto iure
								possimus?
							</p>
						</div>
					</div>
