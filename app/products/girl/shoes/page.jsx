...
export default function GirlShoesPage() {
  ...
  useEffect(() => {
    dispatch(getProducts("girl", "shoe"));
  }, [dispatch]);
  ...
  return (
    <main className="pt-[9rem] min-h-[100vh]">
      <section className="w-[70%] mx-[auto] flex py-[3rem]">
        ...
        {products && products.length > 0 ? <FilterBar products={products} gender={"girl"} category={"shoe"} /> : <SkeletonFilterBar />}
