...
export default function FemaleSweatshirtPage() {
    ...
    useEffect(() => {
      dispatch(getProducts("female", "hoodie"));
    }, [dispatch]);
    ...
    return (
      ...
      <section className="w-[70%] mx-[auto] flex py-[3rem]">
        ...
        {products && products.length > 0 ? <FilterBar products={products} gender={"female"} category={"hoodie"} /> : <SkeletonFilterBar />}
