...
export default function GirlSweatshirtPage() {
    ...
    useEffect(() => {
      dispatch(getProducts("girl", "hoodie"));
    }, [dispatch]);
    ...
    return (
      ...
      <section className="w-[70%] mx-[auto] flex py-[3rem]">
        ...
        {products && products.length > 0 ? <FilterBar products={products} gender={"girl"} category={"hoodie"} /> : <SkeletonFilterBar />}
