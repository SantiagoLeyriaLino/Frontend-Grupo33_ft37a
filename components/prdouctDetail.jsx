              ...
              <article className="w-[35%] flex flex-col gap-y-[2rem]">
                <div className="w-[80%] mx-[auto]">
                  ...
                  <select
                    name=""
                    id=""
                    className="text-black p-[0.6rem] w-[100%] text-center"
                  >
                  ...
                  <div className="flex flex-col gap-y-[0.6rem] mt-[2rem]">
                    <Link
                      href={'/checkout'}
                      className="text-white p-[0.6rem] w-[100%] text-center bg-[#FA8B61] hover:bg-[#F8652A] font-bold"
                    >
                      Comprar
                    </Link>
                    <span
                      onClick={addMyCart}
                      className="text-[#F8652A] p-[0.6rem] w-[100%] text-center border-[1px] border-[#F8652A] cursor-pointer hover:bg-[#E9E9ED]"
                    >
                      Agregar a carrito
                    </span>
                    <span className="text-[#11111180] border-[1px] border-[#11111180]  p-[0.6rem] w-[100%] text-center bg-[#E9E9ED] cursor-pointer hover:text-black">
                      ♥ Agregar a favoritos
                    </span>
                  </div>
                </div>
                    ...
                    {productDetail[1]?.map((img, index) => {
                      return (
                        <Link
                          ...
                          href={`/products/hombres/zapatillas/${img?._id}`}
                          key={index}
                        >
                          <Image
                            src={img?.images[0]}
