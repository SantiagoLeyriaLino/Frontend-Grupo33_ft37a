...
export default function ChildrenSweatshirtPage() {
    ...
    useEffect(() => {
      dispatch(getProducts("child", "hoodie"));
    }, [dispatch]);
    ...
    return (
      ...
      <section className="w-[70%] mx-[auto] flex py-[3rem]">
        ...
        {products && products.length > 0 ? <FilterBar products={products} gender={"child"} category={"hoodie"} /> : <SkeletonFilterBar />}
